...
// export NS_LOG=LteMultiTraffic=info
#include <iomanip>
#include <iostream>
...
NS_LOG_COMPONENT_DEFINE( "LteMultiTraffic" );
...
int main(int argc, char const *argv[]) {
    ...
    Time simDuration = Seconds(30.0);  // In Seconds
    Time startTime_echoServerApp    = Seconds(50.100);
    Time stopTime_echoServerApp     = Seconds(53.000);
    Time startTime_echoClientApp    = Seconds(50.250);
    Time stopTime_echoClientApp     = Seconds(52.750);
    Time startTime_voipApp          = Seconds(55.000);
    Time stopTime_voipApp           = Seconds(58.000);
    Time startTime_FTPSrcApp        = Seconds(1.10);
    Time startTime_FTPSnkApp        = Seconds(1.00);
    ...
    Config::Connect( "/NodeList/*/DeviceList/0/LteUePhy/ReportCurrentCellRsrpSinr", MakeCallback(&ReportUeMeasurements) );
    ...
    svrApp.Start( startTime_echoServerApp );   svrApp.Stop( stopTime_echoServerApp );
    ...
    clientApp.Start( startTime_echoClientApp );    clientApp.Stop( stopTime_echoClientApp );
    // ########################### END OF APP SETUP ############################
    ...
    //
    // voipApps.Add( sourceApps ); voipApps.Add( sinkApps );
    // voipApps.Start( startTime_voipApp );
    // voipApps.Stop( stopTime_voipApp );
    // // ########################### END OF APP SETUP ############################
