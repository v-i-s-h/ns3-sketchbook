...
# Plot data
figure();
plot( data_u1[:,1], 10*log10(data_u1[:,6])+30, label = "User 1" );
plot( data_u2[:,1], 10*log10(data_u2[:,6])+30, label = "User 2" );
plot( data_u3[:,1], 10*log10(data_u3[:,6])+30, label = "User 3" );
plot( data_u4[:,1], 10*log10(data_u4[:,6])+30, label = "User 4" );
grid();
ylabel( "SINR(dBm)" );
xlabel( "Time" );
